...
public class NewExtractor {
    ...
    public NewExtractor(int cutoff) {
        this.cutoff = cutoff;
    }

    public NewExtractor with(int cutoff) {
    ...
    public List<ExtractedResult> extractWithoutOrderReverse(String query, Collection<String> choices,
            Applicable func) {
        List<ExtractedResult> yields = new ArrayList<>();
        int index = 0;
